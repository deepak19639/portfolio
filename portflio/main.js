...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (sendBtn) {
    sendBtn.addEventListener('click', () => {
      ...
      const mailto  = `mailto:deepak19639@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;

      // Try window.open first (more reliable than location.href)
      ...
      if (formNote) {
        formNote.innerHTML = '✅ Email client should open now. If it didn\'t, <a href="mailto:deepak19639@gmail.com" style="color:var(--amber)">click here</a> to email directly.';
